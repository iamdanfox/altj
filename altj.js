...
var App, DistributionComp, Graph, GrowComp, HistogramComp, NormalDistribution, RaphaelComp, SidebarComp, SpikynessComp, TitleComp, TriModal, augment, button, dist, distbetween, div, drawgraph, edgelen, eq, graph, h, h1, input, intersects, intriangle, label, newpoints, normalDist, paper, randX, randY, shortcut, triModalDist, w, _ref,
...
HistogramComp = React.createClass({
  ...
  drawBars: function() {
    var b, bucketsize, edge, histogram, key, l, offset, val, _i, _len, _ref1, _results;
    bucketsize = 5;
    offset = -3 * bucketsize;
    histogram = {};
    _ref1 = graph.edges;
