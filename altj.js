...
var AUGMENT_PROPORTION, App, Graph, GrowComp, NormalDistribution, RaphaelComp, SidebarComp, TitleComp, TriModal, a, augment, button, dist, distbetween, div, drawgraph, edgelen, eq, graph, grow, growN, h, h1, intersects, intriangle, keypress, newpoints, normalDist, randX, randY, setMoreRandom, setMoreRegular, setRound, setSpiky, shortcut, triModalDist, w, _ref,
...
_ref = React.DOM, h1 = _ref.h1, a = _ref.a, div = _ref.div, button = _ref.button;
...
GrowComp = React.createClass({
  render: function() {
    return div({
      ...
      }, "Grow"), button({}, "Grow 20"), button({}, "Restart")
    ]);
  }
});
...
grow = function() {
  var success;
  if (Math.random() > AUGMENT_PROPORTION) {
    success = shortcut();
    if (!success) {
      return augment();
    }
