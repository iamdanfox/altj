...
var AUGMENT_PROPORTION, Graph, NormalDistribution, TriModal, augment, dist, distbetween, drawgraph, edgelen, eq, graph, grow, growN, h, intersects, intriangle, keypress, newpoints, paper, paper2, randX, randY, setRound, setSpiky, shortcut, w,
...
dist = NormalDistribution.make(edgelen(graph.edges[0]), edgelen(graph.edges[1]), edgelen(graph.edges[2]));
