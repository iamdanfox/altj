...
RaphaelComp = React.createClass({displayName: 'RaphaelComp',
  paper: null,
...
HistogramComp = React.createClass({displayName: 'HistogramComp',
  paper2: null,
  componentDidMount: function() {
...
SidebarComp = React.createClass({displayName: 'SidebarComp',
  render: function() {
    return div({
      className: 'sidebar'
...
TitleComp = React.createClass({displayName: 'TitleComp',
  render: function() {
    return div({
      className: 'section',
      id: 'top'
...
GrowComp = React.createClass({displayName: 'GrowComp',
  render: function() {
    return div({
      className: 'section'
    }, [
...
SpikynessComp = React.createClass({displayName: 'SpikynessComp',
  render: function() {
    return div({
      className: 'section'
    }, [
...
DistributionComp = React.createClass({displayName: 'DistributionComp',
  render: function() {
    return div({
      className: 'section'
    }, [
