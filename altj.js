...
var App, DistributionComp, Graph, GrowComp, HistogramComp, NormalDistribution, SVGComp, SidebarComp, SpikynessComp, TitleComp, TriModal, augment, button, distbetween, div, edgelen, eq, h1, input, intersects, intriangle, label, newpoints, path, shortcut, svg, _ref,
...
_ref = React.DOM, h1 = _ref.h1, div = _ref.div, button = _ref.button, input = _ref.input, label = _ref.label, svg = _ref.svg, path = _ref.path;
